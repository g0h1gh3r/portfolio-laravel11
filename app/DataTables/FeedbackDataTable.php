    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                return '<a href="'.route('admin.feedback.edit', $query->id) .'" class="btn btn-primary mr-1"><i class="fas fa-edit"></i></a>
                        <a href="'.route('admin.feedback.destroy', $query->id) .'" class="btn btn-danger delete-item ml-1"><i class="fas fa-trash"></i></a>';
            })
            ->setRowId('id');
    }

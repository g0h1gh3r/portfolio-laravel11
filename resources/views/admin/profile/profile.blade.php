                                    ...
                                    <form method="post" action="{{ route('password.update') }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4 col-12">
                                                ...
                                                <input type="password" class="form-control" name="password" autocomplete="new_password">
                                            ...
                                            <div class="form-group col-md-4 col-12">
                                                ...
                                                <input type="password" class="form-control" name="password_confirmation" autocomplete="new_password">

                            ...
                            <form action="{{ route('admin.skill-section-setting.update', 1) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" name="title" value="{{ $skillSectionSetting->title }}" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Subtitle</label>
                                    <div class="col-sm-12 col-md-7">
                                        <textarea name="subtitle" id="" class="form-control"  style="height: 150px">{!! $skillSectionSetting->title !!}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
